...
parser.add_argument('--filling', dest="filling",  nargs=5,
                    metavar=("symbol", "filling_type", "form_type(eg, 10-K:10K/A:10-K405:10-K405/A)", "start_date", "end_date"),
                    help="update sec fillings by symbol")
parser.add_argument('--filling_all(', dest="filling_all",  nargs=4,
                    metavar=("filling_type", "form_type(eg, 10-K:10K/A:10-K405:10-K405/A)", "start_date", "end_date"),
